...
mod test {
    ...
    use super::super::{
        LONG_DISTANCE_HIGH_TRIP, LONG_DISTANCE_LOW_TRIP, OPEN_PLUS_TRIP, OPEN_TRIP,
        VALUE_PLUS_TRIP, VALUE_TRIP,
    };
    use assert_float_eq::*;

    #[test]
    fn test_plan_name() {
        assert!(OPEN_TRIP.plan_name() == "Open");
        assert!(OPEN_PLUS_TRIP.plan_name() == "Open Plus");
        assert!(VALUE_TRIP.plan_name() == "Value");
        assert!(VALUE_PLUS_TRIP.plan_name() == "Value Plus");
        assert!(LONG_DISTANCE_HIGH_TRIP.plan_name() == "Long Distance (high season)");
        assert!(LONG_DISTANCE_LOW_TRIP.plan_name() == "Long Distance (low season)");
    }
    #[test]
    fn test_km_cost() {
        ...
        assert_f32_near!(LONG_DISTANCE_HIGH_TRIP.km_cost(50), 11.5);
        assert_f32_near!(LONG_DISTANCE_LOW_TRIP.km_cost(50), 11.5);
        ...
        assert_f32_near!(LONG_DISTANCE_HIGH_TRIP.km_cost(175), 40.25);
        assert_f32_near!(LONG_DISTANCE_LOW_TRIP.km_cost(175), 40.25);

        assert_f32_near!(LONG_DISTANCE_HIGH_TRIP.km_cost(400), 84.0);
        assert_f32_near!(LONG_DISTANCE_LOW_TRIP.km_cost(400), 84.0);
    }
    ...
    fn test_time_cost() {
        ...
        assert_f32_near!(LONG_DISTANCE_HIGH_TRIP.time_cost(&t.trip_time()), 50.0);
        assert_f32_near!(LONG_DISTANCE_LOW_TRIP.time_cost(&t.trip_time()), 40.0);
        ...
        assert_f32_near!(LONG_DISTANCE_HIGH_TRIP.time_cost(&t.trip_time()), 92.0);
        assert_f32_near!(LONG_DISTANCE_LOW_TRIP.time_cost(&t.trip_time()), 69.95);
        ...
        assert_f32_near!(LONG_DISTANCE_HIGH_TRIP.time_cost(&t.trip_time()), 260.0);
        assert_f32_near!(LONG_DISTANCE_LOW_TRIP.time_cost(&t.trip_time()), 189.75);

        // 8 day 4h Trip
        t = Trip::new(start, Time::new(20, 32, 11, 8, 2025), 10);
        assert_f32_near!(LONG_DISTANCE_HIGH_TRIP.time_cost(&t.trip_time()), 304.0);
        assert_f32_near!(LONG_DISTANCE_LOW_TRIP.time_cost(&t.trip_time()), 244.9);
    }
    #[test]
    fn test_total_cost() {
        ...
        assert_f32_near!(OPEN_PLUS_TRIP.calculate_cost(&t).total_cost, 419.02335);
        assert_f32_near!(VALUE_TRIP.calculate_cost(&t).total_cost, 397.14);
    }
}
